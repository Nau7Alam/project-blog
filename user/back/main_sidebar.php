      		  ...
      		  <div class="admin-side-bar" >
					 ...
					 <div class="menu-item">
					        <div class="admin-img-box">
					 	        <img class='admin-img' src="../img_box/frontFiles/<?php
                                                            if(empty($_SESSION['user_image'])){
                                                                echo("pop.jpg");
                                                            }else
                                                            echo($_SESSION['user_image']); 
                                                            
                                                            ?>" title="UserImage" width="100%"  alt="">
					 	    </div>
                         ...
                         <div class="view-button-box">
                                ...
                                <div id='show-projects' class="view-button project-button">PROJECTS</div>
                                <div  id='show-posts' class="view-button post-button">POSTS</div>
...
<!--					 		<div class="post-opts"> <a href="update-post.php"> <i class="fas fa-edit"></i> Update Post </a> </div>-->
					 	</div>
					 </div>
