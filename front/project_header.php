<header>
	...
	<nav class='nav-bar'>
	   ...
	   <div class="dropdown-container">
               ...
               echo("<div class='nav-item drop-item'><li class='account'><a href='user/user.php'><img class='user_img' height='35' width='35' class='account-img' src='img_box/frontFiles/{$username}' title='account' > {$_SESSION['username']}</a></li></div>
               {$menu_options}
            ...
            echo("{$menu_options}<div class='nav-item drop-item'><li><a href='user/login.php'>Log In</a></li></div>
                  <div class='nav-item drop-item'><li><a href='user/signup.php'>Sign Up</a></li></div>");
